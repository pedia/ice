...
```
set ICE_HOME=C:\Program Files\ZeroC\Ice-3.8.0 (MSI installation)
```
...
```
glacier2-compat-3.8a0.jar
ice-compat-3.8a0.jar
icebox-compat-3.8a0.jar
icebt-compat-3.8a0.jar
icediscovery-compat-3.8a0.jar
icegrid-compat-3.8a0.jar
icelocatordiscovery-compat-3.8a0.jar
icestorm-compat-3.8a0.jar
```
